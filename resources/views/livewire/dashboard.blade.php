    ...
    <div class="row">
        <div class="col-lg-6 mb-4">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white">
                    <h6 class="mb-0">História de Temperatura</h6>
                </div>
                <div class="card-body">
                    <canvas id="graficoTemperatura" height="200"></canvas> {{-- rendereizar o nosso gráfico, de maneira a deixar animado --}}
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    <canvas id="graficoSensores" height="200"></canvas> {{-- rendereizar o nosso gráfico, de maneira a deixar animado --}}
                </div>
            </div>
        </div>
